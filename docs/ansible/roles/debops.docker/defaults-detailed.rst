...
These variables are lists of networks with parameters from the
`Ansible docker_network module`_.
...
These variables are lists of registry accounts with parameters from the
`Ansible docker_login module`_.
...
These variables are lists of registry accounts with parameters from the
`Ansible docker_container module`_.

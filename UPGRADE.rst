...
The functionality of the debops.subnetwork_ role has been merged into
``debops.ifupdown`` role. You should move existing debops.subnetwork_
...
debops.subnetwork_ from remote hosts; ``debops.ifupdown`` maintains its own set of

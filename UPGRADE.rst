...
manages the APT proxy configuration.
...
.. literalinclude:: scripts/upgrade-proxy-from-v0.3.x-to-v0.4.x
   :language: shell

The script is bundled with this role under
:file:`scripts/upgrade-proxy-from-v0.3.x-to-v0.4.x` and can be invoked from
their.

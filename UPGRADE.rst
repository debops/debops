...
.. _tinc__ref_upgrade_nodes_v0.2:

Upgrade from v0.2.X to v0.2.2
-----------------------------
...
.. literalinclude:: scripts/upgrade-from-v0.2.X-to-v0.2.2
   :language: shell

The script is bundled with this role under
:file:`docs/scripts/upgrade-from-v0.2.X-to-v0.2.2` and can be invoked from
their.

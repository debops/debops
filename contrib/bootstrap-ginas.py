...
class CLI:
  ...
  def success_message(self):
    ...
    self.log_with_color(36, "Your computer has been added to an ansible_controller group in inventory/hosts:")
    self.log_with_color(35, "Please make sure to check out this file if you do not want this behavior\n")
